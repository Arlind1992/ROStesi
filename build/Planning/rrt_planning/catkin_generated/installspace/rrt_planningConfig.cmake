...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rrt_planning' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/arlind/Desktop/Workspace/RosProj/Planning/install/${idir}'.  Ask the maintainer 'Arlind Rufi <arlind.rufi@polimi.it>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/arlind/Desktop/Workspace/RosProj/Planning/install/lib;/home/arlind/Desktop/Workspace/RosProj/Planning/devel/lib;/opt/ros/kinetic/lib)
